...
urlpatterns = [
    ...
    path(route='reviews/dealer/<int:dealer_id>',
         view=views.get_dealer_reviews, name='dealer_reviews_by_dealer'),
    path(route='get_cars', view=views.get_cars, name='get_cars'),
    path(route='dealer-reviews', view=views.get_dealer_reviews,
         name='dealer_reviews'),
    path(route='add-review', view=views.add_review,
         name='add_review')
